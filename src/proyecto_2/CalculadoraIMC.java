...
private double CalcularIMC(double peso, double altura) {
    ...
    public String obtenerConsejosSalud(double imc){
        if (imc < 18.5) {
    ...
    public String obtenerRangoPeso() {
    double imc = CalcularIMC(Double.parseDouble(pesoTextField.getText()), Double.parseDouble(alturaTextField.getText()));
    if (imc < 18.5) {
        return "Estás bajo de peso. Es importante aumentar tu consumo calórico.";
    } else if (imc < 25) {
        return "Tu peso está dentro del rango saludable. ¡Sigue manteniendo un estilo de vida saludable!";
    ...
    private void initComponents() {
        ...
        jPanel1.add(resultadoLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 290, 300, 40));
